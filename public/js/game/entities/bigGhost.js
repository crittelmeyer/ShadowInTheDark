...
.defines(function(){
	EntityBigGhost = EntityRandomWanderAI.extend({
		...
		deathSound: new ig.Sound('/audio/gibbed1.*'),
		spawnSounds: [new ig.Sound('/audio/burp.*'), new ig.Sound('/audio/burp2.*')],
		flip: false,
		animSheet: new ig.AnimationSheet('/img/bubbleBobbleGhost.gif', 24, 24),
