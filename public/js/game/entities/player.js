...
.defines(function(){
	EntityPlayer = ig.Entity.extend({
		//Superficial values
		hurtSound: new ig.Sound('/audio/warriorHurt1.*'),
		deathSound: new ig.Sound('/audio/warriorDeath1.*'),
		animSheet: new ig.AnimationSheet('/img/shadow.gif', 16, 24),
		flip: false,
		...
		dirAction: function(strType) {
			...
			var swordX = this.faceDir == 'side' ? 19 : 24, swordY = this.faceDir == 'side' ? 24 : 19, weaponURL = '/img/sword-' + (this.faceDir == 'side' ? 'side' : 'up') + '.gif';
